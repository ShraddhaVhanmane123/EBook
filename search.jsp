...
%>
	...
	<div class="container-fluid">
		<div class="row p-3">
			...
			List<BookDetails> list2 = dao2.getBookBySearchh(ch);
			...
			<div class="col-md-3">
				<div class="card crd-ho mt-2">
					<div class="card-body text-center">
						...
						<div class="row <%=b.getBookCategory().equals("Old") ? "" : "justify-content-center"%>">
							<%
							...
							%>
								<a href="cart?bid=<%=b.getBookId()%>" class="btn btn-danger btn-sm">
									<i class="fa-solid fa-cart-plus"></i> Add Cart
								</a>
							<%
								}
